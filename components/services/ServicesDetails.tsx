    ...
    <>
      {width > 768 ? (
        <div
          className={`${
            idx % 2 != 0
              ? 'bg-black text-white py-20 px-5 rounded-2xl transition-all hover:-translate-y-2 hover:shadow-2xl cursor-pointer'
              : ''
          } py-20 my-10`}
        >
          <Row gutter={[16, 16]} align="middle">
            ...
            <Col xs={24} md={12} pull={idx % 2 != 0 ? 12 : 0}>
              <div
                className={`flex ${
                  idx % 2 != 0 ? 'justify-center' : 'justify-end'
                }`}
              >
                <Image
                  preview={false}
        ...
        <div
          className={`${
            idx % 2 != 0
              ? 'bg-black text-white px-5 rounded-2xl transition-all hover:-translate-y-2 hover:shadow-2xl cursor-pointer'
              : ''
          } py-8 xl:py-20 my-10`}
        >
          <Row gutter={[16, 16]} align="middle">
